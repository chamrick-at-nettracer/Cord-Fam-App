# Getting Started with Cord-Fam-App

Welcome to Cord-Fam-App! This guide will help you get started with using the
...
3. Use the formatting toolbar for rich text:
   ...
   - _Italic_: Click the _I_ button or use `*text*`
...
Access your profile settings by clicking the Settings icon (⚙️) in the top
right.
...
_This documentation is a work in progress and will be updated as features are
added._
